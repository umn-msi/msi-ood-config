## Interactive Apps Missing?

Open OnDemand will hide the Interactive Apps menu from the interface when the private user directory reaches its storage or file limit. Please see [Managing Home Directory](https://msi.umn.edu/our-resources/knowledge-base/managing-home-directory) for more information on lowering storage usage in the home directory.
...
* View your [Active Jobs](https://ondemand.msi.umn.edu/pun/sys/dashboard/activejobs)
